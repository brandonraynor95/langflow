...
def _load_sdk() -> Any:
    try:
        ...
        msg = "langflow-sdk is required for lfx login. Install it with: pip install langflow-sdk"
...
def _api_key_env_name(env_name: str, environments_file: str | None) -> str | None:
    ...
    try:
        ...
        if config_path is None:
            return None
        all_envs_raw, _ = _load_config(config_path)
        _ = all_envs_raw  # already parsed to LangflowEnvironment objects — we need the raw dict
