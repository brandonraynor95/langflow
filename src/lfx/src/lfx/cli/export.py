...
def _load_sdk() -> Any:
    ...
    try:
        ...
        msg = "langflow-sdk is required for remote export. Install it with: pip install langflow-sdk"
...
def export_command(
    ...
    *,
    ...
    if flow_id or project_id:
        ...
        dest_dir = Path(output_dir) if output_dir else Path.cwd() / _safe_filename(project.name)
        dest_dir.mkdir(parents=True, exist_ok=True)
