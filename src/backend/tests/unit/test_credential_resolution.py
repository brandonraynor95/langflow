...
class TestGetApiKeyForProviderDbFallback:
    ...
    def test_should_fallback_to_env_when_db_lookup_raises_value_error(
        self, mock_run, mock_mapping, monkeypatch
    ):
        ...
        This is the exact scenario in Desktop: user configured OPENAI_API_KEY via UI in 1.7.2,
        but after upgrade to 1.8.2, the DB lookup fails and there's no env fallback.
        """
    ...
    @patch("lfx.base.models.unified_models.get_model_provider_variable_mapping")
    @patch("lfx.base.models.unified_models.run_until_complete")
    def test_should_fallback_to_env_when_db_lookup_returns_empty_string(
        self, mock_run, mock_mapping, monkeypatch
    ):
    ...
    @patch("lfx.base.models.unified_models.get_model_provider_variable_mapping")
    @patch("lfx.base.models.unified_models.run_until_complete")
    def test_should_fallback_to_env_when_variable_service_is_none(
        self, mock_run, mock_mapping, monkeypatch
    ):
    ...
    @patch("lfx.base.models.unified_models.get_model_provider_variable_mapping")
    @patch("lfx.base.models.unified_models.run_until_complete")
    def test_should_return_none_when_both_db_and_env_unavailable(
        self, mock_run, mock_mapping, monkeypatch
    ):
    ...
    @patch("lfx.base.models.unified_models.get_model_provider_variable_mapping")
    @patch("lfx.base.models.unified_models.run_until_complete")
    def test_should_return_db_value_when_db_lookup_succeeds(
        self, mock_run, mock_mapping
    ):
