...
import exampleApiMonitorGetVertexBuilds from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/get-vertex-builds.sh';
import resultApiMonitorResultGetVertexBuilds from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/result-get-vertex-builds.json';
import exampleApiMonitorDeleteVertexBuilds from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/delete-vertex-builds.sh';
import resultApiMonitorResultDeleteVertexBuilds from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/result-delete-vertex-builds.txt';
import exampleApiMonitorGetMessages from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/get-messages.sh';
import exampleApiMonitorGetMessages2 from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/get-messages-2.sh';
import resultApiMonitorResultGetMessages2 from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/result-get-messages-2.json';
import exampleApiMonitorDeleteMessages from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/delete-messages.sh';
import resultApiMonitorResultDeleteMessages from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/result-delete-messages.txt';
import exampleApiMonitorUpdateMessage from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/update-message.sh';
import resultApiMonitorResultUpdateMessage from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/result-update-message.json';
import exampleApiMonitorUpdateSessionId from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/update-session-id.sh';
import resultApiMonitorResultUpdateSessionId from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/result-update-session-id.json';
import exampleApiMonitorDeleteMessagesBySession from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/delete-messages-by-session.sh';
import resultApiMonitorResultDeleteMessagesBySession from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/result-delete-messages-by-session.txt';
import exampleApiMonitorExampleRequest from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/example-request.sh';
import exampleApiMonitorGetTransactions from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/get-transactions.sh';
import resultApiMonitorResultGetTransactions from '!!raw-loader!@site/API-Reference/curl-examples/api-monitor/result-get-transactions.json';
