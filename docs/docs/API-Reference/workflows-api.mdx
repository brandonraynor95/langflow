...
import exampleTypescriptWorkflowsApiExampleSynchronousRequest from '!!raw-loader!@site/docs/API-Reference/javascript-examples/workflows-api/example-synchronous-request.ts';
...
import exampleTypescriptWorkflowsApiExampleAsynchronousRequest from '!!raw-loader!@site/docs/API-Reference/javascript-examples/workflows-api/example-asynchronous-request.ts';
...
import exampleTypescriptWorkflowsApiExampleRequest from '!!raw-loader!@site/docs/API-Reference/javascript-examples/workflows-api/example-request.ts';
...
import exampleTypescriptWorkflowsApiExampleRequest2 from '!!raw-loader!@site/docs/API-Reference/javascript-examples/workflows-api/example-request-2.ts';
...
<CodeBlock language="typescript">{exampleTypescriptWorkflowsApiExampleSynchronousRequest}</CodeBlock>
...
<CodeBlock language="typescript">{exampleTypescriptWorkflowsApiExampleAsynchronousRequest}</CodeBlock>
...
<CodeBlock language="typescript">{exampleTypescriptWorkflowsApiExampleRequest}</CodeBlock>
...
<CodeBlock language="typescript">{exampleTypescriptWorkflowsApiExampleRequest2}</CodeBlock>
